 ...
 */
void printMatrixUbr(
    const CBLAS_ORDER order, /* CBLAS row order */
...
/* ******************************************************************************************************************************
 */
void printMatrix(const CBLAS_ORDER order, int n, int m, REALT *a, int wide,
...
/* ******************************************************************************************************************************
 */
void printMatrixThr(const CBLAS_ORDER order, int n, int m, REALT *a,
...
/* ******************************************************************************************************************************
 */
void printMatrixUbr(const CBLAS_ORDER order, /* CBLAS row order */
                    int n, int m, REALT *a, /* Size and array */
                    char *inStr,
